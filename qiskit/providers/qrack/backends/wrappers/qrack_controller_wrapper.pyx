...
cdef extern from "qrack_controller.hpp" namespace "AER::Simulator":
    cdef cppclass QrackController:
        ...
        void initialize_qreg(bool use_opencl, bool use_qunit, bool use_qpager, unsigned char num_qubits, int opencl_device_id, bool opencl_multi, bool doNormalize, double zero_threshold) except +
...
cdef class PyQrackController:
    ...
    def initialize_qreg(self, use_opencl, use_qunit, use_qpager, num_qubits, opencl_device_id, opencl_multi, doNormalize, zero_threshold):
        self.c_class.initialize_qreg(use_opencl, use_qunit, use_qpager, num_qubits, opencl_device_id, opencl_multi, doNormalize, zero_threshold)
