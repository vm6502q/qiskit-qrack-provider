...
cdef extern from "qrack_controller.hpp" namespace "AER::Simulator":
    cdef cppclass QrackController:
        ...
        void initialize_qreg(bool use_opencl, bool use_gate_fusion, bool use_qunit, unsigned char num_qubits, int opencl_device_id, double zero_threshold) except +
...
cdef class PyQrackController:
    ...
    def initialize_qreg(self, use_opencl, use_gate_fusion, use_qunit, num_qubits, opencl_device_id, zero_threshold):
        self.c_class.initialize_qreg(use_opencl, use_gate_fusion, use_qunit, num_qubits, opencl_device_id, zero_threshold)
